...
#ifndef SNIPROXY_LOG_H
#define SNIPROXY_LOG_H
...
#define SNIPROXY_LOG_LEVEL_FATAL_STRING      "FATAL"
#define SNIPROXY_LOG_LEVEL_ALERT_STRING      "ALERT"
#define SNIPROXY_LOG_LEVEL_CRITICAL_STRING   "CRITICAL"
#define SNIPROXY_LOG_LEVEL_ERROR_STRING      "ERROR"
#define SNIPROXY_LOG_LEVEL_WARNING_STRING    "WARNING"
#define SNIPROXY_LOG_LEVEL_NOTICE_STRING     "NOTICE"
#define SNIPROXY_LOG_LEVEL_INFO_STRING       "INFO"
#define SNIPROXY_LOG_LEVEL_DEBUG_STRING      "DEBUG"

typedef enum snip_log_level_e {
    SNIPROXY_LOG_LEVEL_FATAL = 0, // Values borrowed from syslog.h
    SNIPROXY_LOG_LEVEL_ALERT = 1,
    SNIPROXY_LOG_LEVEL_CRITICAL = 2,
    SNIPROXY_LOG_LEVEL_ERROR = 3,
    SNIPROXY_LOG_LEVEL_WARNING = 4,
    SNIPROXY_LOG_LEVEL_NOTICE = 5,
    SNIPROXY_LOG_LEVEL_INFO = 6,
    SNIPROXY_LOG_LEVEL_DEBUG = 7
} snip_log_level_t;
